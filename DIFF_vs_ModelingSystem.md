...
| Углы | roll/pitch/yaw считаются от переставленного кватерниона `(x, -z, y)` и пишутся в строку GT | roll/pitch/yaw считаются от **сырого NED**-кватерниона и пишутся в `angle.dat` |
